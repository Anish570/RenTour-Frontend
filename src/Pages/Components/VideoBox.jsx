...
const VideoBox = ({ scrollToRef }) => {
    ...
    const handleBrowseProductsClick = () => {
        if (scrollToRef?.current) {
            ...
            navigate("/collections/mobiles")
        }
    };

    const handleHowItWorksClick = () => navigate('/about-us');

    const baseUrl = import.meta.env.VITE_API_BASE_URL;
    const VideoSrc = baseUrl
        ? `${baseUrl}/images/video/Footage1.mp4`
        : "/images/video/Footage1.mp4";
